  ...
  <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
    ...
    <div x-data="{ isActive: false, open: false}">
      ...
      <a href="{{route('qa_manager.dashboard')}}" class="{{activeTab('dashboard')}} nav-tab">
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="{{ route('classSchedule') }}" class="{{activeTab('classSchedule')}} nav-tab">
        <span aria-hidden="true">
          <img src="{{ asset('img/icons/black/Invitation.svg') }}" alt="Invitation" class="w-5 h-5">

        </span>
        <span class="ml-3 text-md"> Schedule </span>
      </a>
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="{{ route('qa_manager.studentperformance') }}" class="{{activeTab('classSchedule')}} nav-tab">
        <span aria-hidden="true">
          <img src="{{ asset('img/icons/black/Invitation.svg') }}" alt="Invitation" class="w-5 h-5">

        </span>
        <span class="ml-3 text-md"> Student Performance </span>
      </a>
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="{{ route('coursemanagement') }}" class="{{activeTab('coursemanagement')}} nav-tab">
        <span aria-hidden="true">
          <img src="{{ asset('img/icons/black/Invitation.svg') }}" alt="Invitation" class="w-5 h-5">
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="#" class="{{activeTab('team')}} nav-tab">
        <span aria-hidden="true">
          <img src="{{ asset('img/icons/black/Invitation.svg') }}" alt="Invitation" class="w-5 h-5">
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="{{route('qa_manager.performance')}}" class="inactive nav-tab">
        <span aria-hidden="true">
