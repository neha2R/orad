  ...
  <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
    ...
    <div x-data="{ isActive: false, open: false}">
      ...
      <a href="{{route('demo_trainer.dashboard')}}" class="{{activeTab('dashboard')}} nav-tab">
    ...
    <div x-data="{ isActive: false, open: false}">
      ...
      <a href="{{ route('availablity') }}" class="{{activeTab('team')}} nav-tab">
        ...
        <span class="ml-3 text-md">Availability </span>
      </a>
    ...
    <div x-data="{ isActive: false, open: false}">
      <!-- active & hover classes 'bg-blue-100 ' -->
      <a href="{{ route('demo_trainer.performance') }}" class="inactive nav-tab">
        <span aria-hidden="true">
