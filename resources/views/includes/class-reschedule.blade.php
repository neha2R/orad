            ...
            <div :class="{ 'mt-4': reschedule.isRescheduleOpening(), 'mt-8': reschedule.isRescheduleOpen() }"
                ...
                <div class="model-container">
                    ...
                    <div class="flex justify-between px-5 py-4">
                        ...
                        <div>
                            <button type="button" class="close" x-on:click="reschedule.rescheduleClose()" wire:click="resetRescheduleInputs()">
                    ...
                    <form wire:submit.prevent="{{$method}}"  method="POST">
                        ...
                        <div class="px-10 py-5 text-gray-600">
                            ...
                            <div class="w-full py-1">
                                <label for="" class="block font-bold ">Class Date :</label>
                                <input type="date" name="" id="" wire:model="classDate" class="form-input">
                                @error('classDate') <span class="text-danger">{{ $message }} @enderror
                            ...
                            <div class="flex w-full py-2 gap-x-2 justify-beteen items-center">
                                <div class="w-1/2 py-1">
                                    ...
                                    <select name="" id="" class="form-input" wire:model="demoid">
                                        ...
                                        @if($rescheduleLeads != null)
                                        @foreach ($rescheduleLeads as $item)
                                            <option value="{{$item->id}}">{{ucwords($item->studentRelation->name ?? '')}}</option>
                                        @endforeach
                                        @else
                                ...
                                <div class="w-1/2 py-1">
                                    <label for="" class="block font-bold ">Select Slot :</label>
                        ...
                        <div class="flex items-center justify-end p-4 ">
                            ...
                            <button x-on:click="reschedule.rescheduleClose()" type="button"
                                class="inline-block btn-mute mr-2" wire:click="resetRescheduleInputs()">Close</button>
