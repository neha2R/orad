        ...
        <div class="py-8" >
            <div>
                <div class="flex justify-between items-center">
                    ...
                    <h3 class="font-normal text-gray-500 my-3 text-xl">Employee of the Month:</h3>
                    <div class="">
                    ...
                    <tbody class="transition duration-700 ease-in-out">
                        ...
                        @php $i =  $data->perPage() * ($data->currentPage() - 1); $key++;@endphp
                            ...
                            <tr>
                                ...
                                <td class="td"><img class="user-img img-radius"
                                        src='{{ asset("storage/$item->photo") }}'
                                        alt="user-img" height="100px" width="100px"></td>
                ...
                <div class="model-container" id="importstaff" style="display:none;">
                    ...
                    <form wire:submit.prevent="store"  method="POST">
                        ...
                        <div class="px-10 py-5 text-gray-600">
                            ...
                            {{-- name  --}}
                            <div class="w-full py-1">
                                <label for="" class="block font-bold ">Emp Name :</label>
