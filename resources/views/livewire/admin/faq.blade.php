        ...
        <div class="py-8" >
            <div>
                <div class="flex justify-between items-center">
                    ...
                    <h3 class="font-normal text-gray-500 my-3 text-xl">FAQ Lists:</h3>
                    <div class="">
                ...
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th class="th" align="left">Show In Policy</th>
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <div class="toggle-div">
                                        <input type="checkbox" name="toggle" id="toggle" class="toggle-input" wire:click="changePolicyStatus({{ $item->id }}, {{ $item->include_in_policy }})" {{ $item->include_in_policy ? 'checked' : '' }}/>
