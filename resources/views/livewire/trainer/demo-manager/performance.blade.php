<section  x-data="{performance:performanceModal(), history:historyModal(), lead:leadModal(),}">
    ...
    <div class="card-section grid gap-4 lg:grid-cols-4 grid-col-1 ">
        ...
        <div  class="card-header shadow-md">
            <span class="card-title"> {{ $totalDemo ?? '' }} </span>
            <p class="card-subtitle">Total Demo</p>
        </div>

        <div class="card-header shadow-md">
            <span class="card-title">  {{ $demoConverted ?? '' }}</span>
            <p class="card-subtitle">Total Demo Converted</p>
        </div>
  
        <div  class="card-header shadow-md">
            <div class="flex flex-col justify-between gap-y-8 h-full text-center">
                <h3 class="font-normal text-mute">Demo Feedback</h3>
                <div>
