...
class Juniorreportatglance extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.sales.juniorreportatglance', compact('data', 'currentearning', 'currentincentive', 'startdate', 'enddate','period'));
    }
}
