...
class Reports extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.training.reports',  ['data' => $data, 'slots' => $slots, 'seniortrainers' => $seniortrainers, 'juniorMarketingTeam'=>$juniorMarketingTeam])->layout('layouts.app', ['pageheading' => $this->pageheading]);
    }
}
